...
import { loginWithGitHub, isAuthenticated } from '@/lib/auth';
        ...
        >
          ...
          >
            ...
            <p className="text-gray-300 text-lg">
              Transform codebases into interactive documentation
            </p>
          </motion.div>
          ...
          >
            ...
            <motion.button
              ...
              className="w-full group relative overflow-hidden bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold py-4 px-6 rounded-xl shadow-lg transition-all duration-300"
            >
